        ...
        <div class="bg-white/90 dark:bg-green-100/80 rounded-xl shadow-2xl p-4 sm:p-8 border border-green-100 dark:border-green-200">
            ...
            <form action="{{ route('barangs.update', $barang) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nama" class="w-full px-4 py-2 rounded-lg border border-green-200 dark:border-green-200 bg-green-50 dark:bg-green-50 focus:ring-2 focus:ring-green-400 focus:outline-none transition" value="{{ $barang->nama }}" required>
                </div>
                <div>
                    <label class="block mb-1 font-semibold text-green-800 dark:text-green-900">Kode Barang</label>
                    <input type="text" name="kode" class="w-full px-4 py-2 rounded-lg border border-green-200 dark:border-green-200 bg-green-50 dark:bg-green-50 focus:ring-2 focus:ring-green-400 focus:outline-none transition" value="{{ $barang->kode }}" required>
                </div>
                <div>
                    <label class="block mb-1 font-semibold text-green-800 dark:text-green-900">Stok</label>
                    <input type="number" name="stok" class="w-full px-4 py-2 rounded-lg border border-green-200 dark:border-green-200 bg-green-50 dark:bg-green-50 focus:ring-2 focus:ring-green-400 focus:outline-none transition" min="0" value="{{ $barang->stok }}" required>
                </div>
                <div>
                    <label class="block mb-1 font-semibold text-green-800 dark:text-green-900">Stok Minimum</label>
                    <input type="number" name="stok_minimum" class="w-full px-4 py-2 rounded-lg border border-green-200 dark:border-green-200 bg-green-50 dark:bg-green-50 focus:ring-2 focus:ring-green-400 focus:outline-none transition" min="0" value="{{ $barang->stok_minimum }}" required>
                </div>
